...
<template>
  ...
  <p class="ml-8 mt-4">Hari ini</p>
  <div v-for="hutang in listHutangHariIni" class="m-8" :key="hutang.id">
    <HutangItem
      :nama="hutang.nama"
      :harga="hutang.harga"
      :waktu="hutang.waktu"
      @clicked-item="onItemClicked"
    />
  </div>
  <p class="ml-8 mt-4">Kemarin</p>
  <div v-for="hutang in listHutangKemarin" class="m-8" :key="hutang.id">
    <HutangItem
      :nama="hutang.nama"
      :harga="hutang.harga"
      :waktu="hutang.waktu"
...
import HutangItem from "./HutangItem.vue";
